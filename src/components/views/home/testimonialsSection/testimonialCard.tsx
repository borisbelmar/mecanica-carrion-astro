...
export function TestimonialCard ({ testimonial }: TestimonialCardProps) {
  return (
    <div
      className="flex-1 bg-white/5 border border-yellow-400/20 backdrop-blur p-6 rounded-xl flex flex-col justify-center text-left min-h-[240px] max-h-[280px] max-w-xl mx-auto"
    >
